...
#TODO Allow P580, P571, P1619 (start dates) only with values in the past
#TODO Allow P582, P576, P3999 (end dates) only with values in the future
...
| . as $item
| .claims as $c
| select($c.P625 and $c.P585 == null
            and $c.P582 == null and $c.P576 == null and $c.P3999 == null
            and $c.P376 == null)
| (first(
    $c.P625[]
